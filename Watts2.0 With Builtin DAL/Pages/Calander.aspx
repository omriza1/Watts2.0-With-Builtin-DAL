<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Calander.Master" AutoEventWireup="true" CodeBehind="Calander.aspx.cs" Inherits="Watts2._0_With_Builtin_DAL.Pages.Calander1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="CalanderV" runat="server">
    <asp:Calendar ID="calendar" runat="server" style="left:300px;top:100px;position:absolute;width:1000px;height:500px;" OnSelectionChanged="calendar_SelectionChanged"  ></asp:Calendar>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="style2" runat="server">
    <style type="text/css">
        body {
            padding: 0;
            margin: 0;
